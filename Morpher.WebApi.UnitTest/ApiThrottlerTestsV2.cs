namespace Morpher.WebApi.UnitTest
{
    ...
    public class ApiThrottlerTestsV2
    {
        ...
        public void Throttle_ByIp()
        {
            ...
            databaseMock.Setup(database => database.GetQueryCountByIp(It.IsAny<string>())).Returns(recordsInDatabase).Verifiable();
        ...
        public void Throttle_ByToken_FromQueryString_PaidUser()
        {
            ...
            databaseMock.Setup(database => database.GetUserLimits(It.IsAny<Guid>())).Returns(
                new CacheObject() { DailyLimit = queryLimit, PaidUser = true, Unlimited = false });
        ...
        [Test]
        public void Throttle_ByToken_FromQueryString_PaidUser_Overlimit()
        {
            int queryLimit = 10;
            int recordsInDatabase = 15;
        ...
        public void Throttle_ByToken_InvalidToken()
        {
            ...
            HttpRequestMessage requestMessage = this.CreateRequest($"http://localhost:0/foo?token={invalidGuid}", HttpMethod.Get);
